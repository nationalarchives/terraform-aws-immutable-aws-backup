...
| <a name="deployments_recovery_point_tags"></a> [recovery_point_tags](#deployments\_recovery\_point\_tags) | A map of tags to add to backups. | `map(string)` | `{}` | no |
...
| <a name="plans_recovery_point_tags"></a> [recovery_point_tags](#plans\_recovery\_point\_tags) | A map of tags to add to backups. If the same tag is added here, it will override the [value set on the deployment](#deployments\_recovery\_point\_tags).  | `map(string)` | `{}` | no |
...
| <a name="rules_recovery_point_tags"></a> [recovery_point_tags](#rules\_recovery\_point\_tags) | A map of tags to add to backups. If the same tag is added here, it will override the [values set on the deployment](#deployments\_recovery\_point\_tags) and [plan](#plans\_recovery\_point\_tags).  | `map(string)` | `{}` | no |
